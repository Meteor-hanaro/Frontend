  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {children}
        <button onClick={handleClose} class="btn btn-primary">닫기</button>
      </div>
    </div>
  );
}
...
function Sign() {
  ...
  const [pdfUrl, setPdfUrl] = useState('https://hanaro-meteor.s3.ap-northeast-2.amazonaws.com/contract/pdf/7a2337f9-724b-4a2b-8cc8-649983056768.pdf');
  ...
  return (
    <div id="signDiv">
      <Modal show={showModal} handleClose={() => setShowModal(false)}>
        ...
        />
        <button onClick={clearCanvas} class="btn btn-primary">초기화</button>
        <button onClick={saveCanvas} class="btn btn-primary">확인</button>
      </Modal>
      <Pdf pdfFile={pdfUrl} />
      <button onClick={signNow} class="btn btn-primary">서명</button>
    </div>
  );
}
